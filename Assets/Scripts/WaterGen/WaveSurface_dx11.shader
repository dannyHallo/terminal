Shader "Custom/WaveSurface" {
	Properties{
		...
		_WaveParam1("Direction (XY), Period (Z), Speed (W)", Vector) = (1, 0, 1, 1)

		[Header(Wave 2)]
		_WaveHeight2("Wave Height", float) = 1
		_WaveSteepness2("Wave Steepness", float) = 1
		_WaveParam2("Direction (XY), Period (Z), Speed (W)", Vector) = (1, 0, 1, 1)

		[Header(Wave 3)]
		_WaveHeight3("Wave Height", float) = 1
		_WaveSteepness3("Wave Steepness", float) = 1
		_WaveParam3("Direction (XY), Period (Z), Speed (W)", Vector) = (1, 0, 1, 1)
		...
		_fresnelIntensity("fresnelIntensity", Range(0, 5)) = 5
